...
Non soddisfatto & RFO01 & L'utente non riconosciuto deve poter registrare un nuovo account \\ \hline
Non soddisfatto & RFO02 & L'utente non riconosciuto deve visualizzare un messaggio d'errore se la registrazione non va a buon fine \\ \hline
Non soddisfatto & RFO03 & L'utente non riconosciuto deve poter effettuare il login \\ \hline
Non soddisfatto & RFO04 & L'utente non riconosciuto deve visualizzare un messaggio se il login non va a buon fine \\ \hline
Non soddisfatto & RFO05 & L'utente autenticato deve poter modificare le informazioni del suo account \\ \hline
Non soddisfatto & RFO06 & L'utente non riconosciuto deve poter effettuare il logout \\ \hline
Non soddisfatto & RFO07 & L'utente autenticato deve poter creare un profilo di tipo cliente \\ \hline
Non soddisfatto & RFO08 & L'utente autenticato deve poter creare un profilo di tipo ristoratore \\ \hline
Non soddisfatto & RFO09 & L'utente autenticato deve visualizzare un messaggio d'errore se la creazione del profilo di tipo ristoratore non va a buon fine \\ \hline
...
Non soddisfatto & RFF01 & Nell'effettuare l'ordinazione, il cliente deve poter aggiungere ingredienti da una pietanza \\ \hline
...
Non soddisfatto & RFF04 & Il cliente deve visualizzare un messaggio d'errore se la suddetta modalità è già stata scelta da un altro cliente afferente alla stessa prenotazione \\ \hline
...
Non soddisfatto & RFF06 & Il cliente e il ristoratore devono ricevere una notifica in concomitanza della ricezione di un messaggio \\ \hline
...
Non soddisfatto & RFF07 & Il ristoratore deve poter visualizzare le prenotazioni presso il suo ristorante implementate come un calendario con le prenotazioni raggruppate per giorno \\ \hline
Non soddisfatto & RFF08 & Il ristoratore deve poter vedere il dettaglio degli ingredienti necessari per ogni giornata \\ \hline
...
Non soddisfatto & RFF09 & Il ristoratore e il cliente devono poter visualizzare la/le loro chat \\ \hline
