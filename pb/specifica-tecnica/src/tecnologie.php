...
HTML & Linguaggio di annotazione (markup) utilizzato per impostare la struttura delle singole pagine e definire gli elementi dell’interfaccia & 5 \\ \hline
...
ReactJs & Libreria grafica per facilitare lo sviluppo front-end gestendo modularmente le componenti grafiche, permettendo performance buone grazie all'efficacia della sua renderizzazione & 18.2.x \\ \hline
...
MaterialUI & Framework di componenti React preconfezionati per la creazione di interfacce utente gradevoli, funzionali e personalizzabili & 4.1.x \\ \hline
Shadcn/ui & Libreria di componenti React utilizzata per facilitare la codifica del front-end, incorporando nell’interfaccia grafica componenti prefabbricate, personalizzabili e altamente riutilizzabili & 0.8.0 \\ \hline

\SetCell[c=3]{c} \textbf{Strumenti e servizi} \\ \hline
Node.js & Runtime system per esecuzione di codice Javascript & 20.11.0 \\ \hline
NPM & Gestore di pacchetti per il linguaggio JavaScript e l'ambiente di esecuzione Node.js & 9.6.x \\ \hline Docker & Piattaforma di sviluppo e gestione di applicazioni che permette di creare, distribuire e eseguire in software in container virtualizzati & 24.0.7 \\ \hline
...
React Testing Library & Libreria di test integrata nativamente che consente di testare il comportamento dei \emph{componenti}$^{G}$ React da una prospettiva degli utenti finali & 14.0.x \\ \hline
