...
?>
    ...
    \hline
    1.0.0 & 2024/05/23 & Alex S. & & Approvazione per il rilascio \\
    \hline
    0.1.0 & 2024/05/23 & Alberto C. & Alex S. & Prima stesura del documento \\
    \hline
    \end{tblr}
    ...
    Alberto Michelazzo ha inoltre spiegato le difficoltà incontrate durante la preparazione del container Docker per l'MVP, mostrando come ci fossero problemi con React. \\
    È stata inoltre rallentata l'implementazione della CI tramite le GitHub Actions. \\

    Questi dubbi verranno esposti al proponente nel prossimo SAL fissato al 24 Maggio.
    \end{document}
