...
\subsubsection{Scopo}
Lo scopo di questo documento è fornire uno starndard da seguire durante il processo di documentazione.

\subsubsection{Ciclo di vita del documento}
Tappe fondamentali del ciclo di vita di ogni documento:
  \begin{itemize}
  ...
  \end{itemize}
  Le prime due fasi sono svolte da tutti i membri del gruppo mentre la terza è affidata esclisivamente al proponente.
