...
\subsubsection{Struttura del documento}
        ...
        \begin{itemize}
          ...
          \begin{itemize}
            \item Redattori: Indica chi si è occupato di redigere il documento;
            \item Verificatori: Indica chi sono stati i verificatori in quel documento;
            \item Destinatari: Indica a chi è destinato il documento;
            \item Versione: Indica l'attuale versione del documento.
          \end{itemize}
        \end{itemize}
...
\subsubsection{Norme tipografiche}
    ...
    \begin{itemize}
      ...
      \item Se vi è un concetto da spiegare esso viene scritto in grassetto seguito da ':' e segue la spiegazione di esso. %mettere che comincia in maiuscola?
    \end{itemize}
