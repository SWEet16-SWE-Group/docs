...
<<<<<<< HEAD
    ...
    \item \textbf{Verifica:} Una volta che una sezione viene completata entra in fase di verifica, dove uno o più verificatori confermeranno le modifiche o rilasceranno dei commenti di correzione; nel secondo caso il documento dovrà nella fase di stesura;
=======
    \item \textbf{Strutturazione:} Creazione di file distinti rappresentanti le singole sezioni dell'indice dei contenuti.;
...
>>>>>>> 0ca59b199be413ee02dbf2f7c094d12a4f05554a
...
\subsubsection{Norme tipografiche}
    ...
    Per i verbali il nome del documento sarà semplicemente la data in cui si è tenuto l'incontro nel formato AAAA/MM/GG.
