...
\begin{itemize}
    ...
    Una percentuale alta indica che il codice è stato testato in modo approfondito nelle sue diverse parti e quindi vi è quindi una minore probabilità ci siano bug;    
    ...
    Metrica utilizzata per calcolare il numero di istruzioni eseguite almeno una volta;
