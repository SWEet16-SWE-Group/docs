...
\begin{itemize}
    \item \textbf{QPC-SFIN - Structural Fan-in}: Indice di utilità, indica quante componenti utilizzano un determinato modulo. 
    Un valore alto indica che il componente è molto usato;
    \item \textbf{QPC-SFOUT - Structural Fan-out}: Indice di dipendenza, indica quante componenti sono utilizzate dalla componente in esame.
    Un valore elevato indica che quest'ultima utilizza molte componenti esterne ad essa.
\end{itemize}
...
\begin{itemize}
    ...
    \item \textbf{QPC-SC - Statement Coverage}: Metrica utilizzata per calcolare il numero di istruzioni eseguite almeno una volta.\\
    Utilizza una tecnica di test chiamata white box che prevede l'esecuzione di tutte le istruzioni presenti nel codice sorgente almeno una volta;
