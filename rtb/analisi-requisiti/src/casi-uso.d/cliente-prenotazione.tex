\pagebreak
\subsubsection{UC15-Visualizzazione lista ristoranti} %UC15: quali informazioni sono visualizzate per ogni ristorante nella lista? 
...
\begin{enumerate}
    ...
    %       \item Se il ristorante in questo momento è aperto o meno.
    %   \end{itemize}
...
\begin{enumerate}
    ...
    \begin{itemize}
        ...
        \item L'indirizzo;
        \item Gli orari di servizio; % su uc7 è segnato giorni di apertura
        \item La/le tipologie di cucine offerte; % manca anche numeri di coperto da uc7
...
\pagebreak
\textbf{UC17.1-Visualizzazione menù}  % nostra svista questa, modificare le descrizioni mettendo 17.1.1, 17.1.2, ecc.
\begin{itemize}
\item \textbf{Attore principale:} Utente non riconosciuto / Cliente.
...
\pagebreak
\textbf{UC17.2-Visualizzazione recensioni} % UC17.2: deve essere modellata come una lista di informazioni
\begin{itemize}
\item \textbf{Attore principale:} Utente non riconosciuto / Cliente.
