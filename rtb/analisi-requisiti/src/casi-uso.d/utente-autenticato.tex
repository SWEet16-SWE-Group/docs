    ...
    \item \textbf{Scenario principale:}
        \begin{enumerate}
            ...
            \item L'utente può inserire:
              \begin{itemize}
                \item La nuova email; % eliminare modifica email (eliminare questa riga)
...
\begin{itemize}
    ...
    \begin{enumerate}
        ...
        \begin{itemize}
            \item Il nome;
            \item Il cognome;
            \item Lo username; % "Lo username per il profilo", ma in realtà, ci seve veramente questo username? Per cosa veniva utilizzato?
...
\begin{itemize}
    ...
    \begin{enumerate}
        ...
        \begin{itemize}
            ...
            \item L'indirizzo;
            \item Giorni di apertura; % manca orari di apertura
...
\subsubsection{UC9-Selezione profilo cliente} % "Non è chiaro quali funzionalità siano rappresentate da UC9 e UC10.", chiaramente cardin non ha capito la funzionalità che vogliamo implementare (ovvero i profili), vedere commento in sezione 3.2
