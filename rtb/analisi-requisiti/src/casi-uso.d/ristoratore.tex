...
\begin{itemize}
        \item Il ristoratore è connesso al sistema e sta visualizzando il dettaglio di una singola prenotazione (vedi UC36-Visualizzazione singola prenotazione);
        \item La prenotazione è nello stato "In attesa".
\end{itemize}
\item \textbf{Postcondizioni:} il ristoratore accetta la prenotazione.
...
\begin{itemize}
        ...
        \item La prenotazione è nello stato "In attesa".
\end{itemize}
\item \textbf{Postcondizioni:} il ristoratore rifiuta la prenotazione.
\item \textbf{Scenario principale:}
\begin{enumerate}
...
\item \textbf{Scenario principale:}
\begin{enumerate}
    \item Il sistema mostra una vista a calendario e per ogni giorno il ristoratore può consultare:
    \begin{itemize}
    ...
    \begin{itemize}
        ...
        \item Il ristoratore può inoltre applicare un filtro in base allo stato prenotazione.
    \end{itemize}
\end{enumerate}
\end{itemize}
...
\begin{itemize}
\item \textbf{Attore principale:} ristoratore.
\item \textbf{Precondizioni:} il ristoratore si trova nella sezione "Visualizzazione lista prenotazioni" (vedi UC35).
...
\begin{itemize}
    ...
    \item \textbf{Precondizioni:} 
    \begin{itemize}
        \item Il ristoratore si trova nella sezione "Visualizzazione lista prenotazioni" (vedi UC35);
    ...
    \item \textbf{Scenario principale:}
    \begin{enumerate}
        \item Il sistema mostra i dettagli e le informazioni relative alla prenotazione selezionata dalIl ristoratore:
        \begin{itemize}
...
\begin{itemize}
    ...
    \item \textbf{Precondizioni:} 
    \begin{itemize}
        \item Il ristoratore si trova nella sezione "Visualizzazione singola prenotazione" (vedi UC36);
...
\begin{itemize}
    ...
    \begin{itemize}
        \item Il ristoratore si trova nella sezione "Visualizzazione singola prenotazione" (vedi UC36);
        \item Il ristoratore seleziona "Ordinazioni per questa prenotazione".
    \end{itemize}
...
\begin{itemize}
    ...
    \item \textbf{Postcondizioni:} il ristoratore gestisce il menù del proprio ristorante.
    \item \textbf{Scenario principale:}
    \begin{enumerate}
        \item Il ristoratore può eseguire le seguenti operazioni all'interno della modifica del menù:
        \begin{itemize}
...
\begin{itemize}
    \item \textbf{Attore principale:} ristoratore.
    \item \textbf{Precondizioni:} il ristoratore si trova nella sezione di gestione del menù (si veda UC37).
    ...
    \begin{enumerate}
        ...
        \end{itemize}
        \item Il sistema aggiorna il menù con la nuova pietanza inserita dalIl ristoratore.
    \end{enumerate}
\end{itemize}
...
\begin{itemize}
    ...
    \item \textbf{Scenario principale:}
    \begin{enumerate}
        \item Il ristoratore modifica il seguente form contenente le informazioni relative alla pietanza:
        \begin{itemize}
            \item Il nome della pietanza;
            \item Seleziona gli ingredienti che compongono la pietanza dalla lista degli ingredienti, con la loro quantità espressa in grammi (si veda UC38 per la creazione di tale lista);
            \item Seleziona la sezione del menù a cui questo piatto appartiene.
        \end{itemize}
        \item Il sistema aggiorna il menù con le modifiche apportate alla pietanza dalIl ristoratore.
    \end{enumerate}
\end{itemize}
...
\begin{itemize}
    \item \textbf{Attore principale:} ristoratore.
    \item \textbf{Precondizioni:} il ristoratore si trova nella sezione di gestione del menù (si veda UC37).
    \item \textbf{Postcondizioni:} il ristoratore ha rimosso una pietanza al menù.
    \item \textbf{Scenario principale:}
    \begin{enumerate}
        \item Il ristoratore elimina una pietanza dal menù.
...
\begin{itemize}
    ...
    \item \textbf{Scenario principale:}
    \begin{enumerate}
        \item Il ristoratore inserisce una nuova sezione al menù.
        \item Il sistema aggiorna il menù con la nuova seziona inserita dalIl ristoratore.
    \end{enumerate}
\end{itemize}
...
\begin{itemize}
    ...
    \item \textbf{Scenario principale:}
    \begin{enumerate}
        \item Il ristoratore modifica una sezione del menù.
        \item Il sistema aggiorna il menù con la sezione modificata dalIl ristoratore.
    \end{enumerate}
\end{itemize}
...
\begin{itemize}
    \item \textbf{Attore principale:} ristoratore.
    \item \textbf{Precondizioni:} il ristoratore si trova nella sezione di gestione del menù (si veda UC37).
    \item \textbf{Postcondizioni:} il ristoratore ha rimosso una sezione del menù.
    \item \textbf{Scenario principale:}
    \begin{enumerate}
        \item Il ristoratore elimina una sezione dal menù.
...
\begin{itemize}
    \item \textbf{Attore principale:} ristoratore.
    \item \textbf{Precondizioni:} il ristoratore ha effettuato l'accesso al sistema.
    \item \textbf{Postcondizioni:} il ristoratore gestisce la lista degli ingredienti del suo ristorante.
    \item \textbf{Scenario principale:}
    \begin{enumerate}
        \item Il ristoratore può eseguire le seguenti operazioni all'interno della modifica della lista degli ingredienti:
        \begin{itemize}
...
\begin{itemize}
    ...
    \item \textbf{Postcondizioni:} il ristoratore ha inserito un nuovo ingrediente nella lista.
    \item \textbf{Scenario principale:}
    \begin{enumerate}
        \item Il ristoratore compila il seguente form contenente le informazioni relative alla pietanza:
        \begin{itemize}
        ...
        \end{itemize}
        \item Il sistema aggiorna la lista degli ingredienti con il nuovo ingrediente inserito dalIl ristoratore.
    \end{enumerate}
\end{itemize}
...
\begin{itemize}
    \item \textbf{Attore principale:} ristoratore.
    \item \textbf{Precondizioni:} il ristoratore si trova nella sezione di gestione della lista ingredienti (si veda UC38).
    \item \textbf{Postcondizioni:} il ristoratore ha rimosso un ingrediente dalla lista.
    \item \textbf{Scenario principale:}
    \begin{enumerate}
        \item Il ristoratore elimina un ingrediente dalla lista di ingredienti.
...
\begin{enumerate}
    ...
    \item Il ristoratore visualizza la notifica relativa alla conferma dell'ordinazione.
\end{enumerate}
\end{itemize}
