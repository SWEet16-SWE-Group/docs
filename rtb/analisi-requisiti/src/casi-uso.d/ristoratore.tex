...
\end{itemize}
\item \textbf{Postcondizioni:} l'utente ristoratore visualizza la lista delle prenotazioni (in qualsiasi stato esse si trovino) attraverso una vista a calendario, suddivise per giorno.
\item \textbf{Scenario principale:}
\begin{itemize}
