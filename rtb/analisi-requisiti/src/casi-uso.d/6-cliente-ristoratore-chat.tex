...
\begin{enumerate}
    ...
    \item Il destinatario rice il messaggio.
\end{enumerate}
\end{itemize}

% ridondante con l'apertura della chat
\textbf{UC51.2-Lettura messaggio}  % UC50.2 deve essere analizzato più in dettaglio (com'è fatta una chat? 
%Quali informazioni sono visualizzate per ogni singolo messaggio?). 
\begin{itemize}
\item \textbf{Attore principale:} Cliente / Ristoratore
\item \textbf{Precondizioni:} È stata aperta la chat.
