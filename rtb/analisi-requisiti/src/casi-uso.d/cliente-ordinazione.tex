...
\begin{enumerate}
    \item Il cliente visualizza la sua ordinazione se già confermata, le ordinazioni già effettuate e confermate dagli altri utenti facenti parte della prenotazione;
    ...
    \item Il cliente confermare la sua ordinazione (si veda UC25.3);
...
\textbf{UC25.3-Conferma ordinazione}
\begin{itemize}
\item \textbf{Attore principale:} Cliente.
\item \textbf{Precondizioni:} 
\begin{itemize}
    \item Il cliente seleziona conferma la sua ordinazione.
    \item Il sistema aggiorna le informazioni sull'ordinazione del cliente.
\end{itemize}
