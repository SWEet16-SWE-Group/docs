...
\begin{itemize}
\item Offrire ai \emph{clienti}$^{G}$ la possibilità di effettuare la \emph{prenotazione}$^{G}$ e l'\emph{ordinazione}$^{G}$ presso un ristorante in maniera intuitiva e divertente, potendo collaborare fra di loro e personalizzare le pietanze;
...
\begin{itemize}
\item \textbf{Creazione e gestione di un profilo}: L'utente può creare e gestire (cioè modificare e/o cancellare i dati ad esso relativi) uno o più \emph{profili}$^{G}$ di tipo cliente e/o ristoratore;
\item \textbf{Ordinazione collaborativa di una o più pietanze}: I clienti afferenti alla stessa prenotazione possono ordinare ognuno una o più pietanze, le quali saranno visualizzate in un unico \emph{carrello}$^{G}$;
\item \textbf{Suddivisione del conto}: Il cliente che ha effettuato la prenotazione può scegliere la modalità secondo la quale dividere il \emph{conto}$^{G}$ prima del pagamento, con gli altri clienti afferenti alla sua stessa prenotazione;
...
\item \textbf{Comunicazione con il cliente}: Il ristoratore, analogamente al cliente, può instaurare un canale di comunicazione con il cliente, mandandogli e ricevendo messaggi visualizzati all'interno di un'apposita \emph{chat}$^{G}$;
