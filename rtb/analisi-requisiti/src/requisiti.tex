...
\begin{center}
    \begin{tblr}{
        ...
        \textbf{Codice} & \textbf{Caratteristica} & \textbf{Descrizione} & \textbf{Fonte} \\
         ...
         RFD3 & Sicurezza & Le comunicazioni tra il client e il server devono essere crittografate, data la natura sensibile dei dati inseriti dagli utenti (tramite SSL/TLS) & Capitolato \\ \hline
         RFF4 & Sicurezza & Viene implementato RSA come sistema di autenticazione per controllare l'accesso ai dati degli utenti & Capitolato \\ \hline
...
\begin{center}
    \begin{tblr}{
        ...
        RNFQO1 & Sviluppo & Il sistema sarà sviluppato seguendo quanto scritto nelle Norme di Progetto & Brainstorming Interno \\ \hline
        RNFQO2 & Sviluppo & Il progetto sarà pubblicato su GitHub & Brainstorming Interno \\ \hline
        RNFQD3 & Sviluppo & Il progetto deve essere accompagnato con un manuale utente & Brainstorming Interno \\ \hline
...
\begin{center}
    \begin{tblr}{
        ...
        RNFVO2 & Portabilità & Il sistema dovrà funzionare sul browser Firefox dalla versione più recente (124.0) & Capitolato \\ \hline
        RNFVO3 & Portabilità & Il sistema dovrà funzionare sul browser Chromium dalla versione più recente (123.0.6312.58) & Capitolato \\ \hline
        RNFVO4 & Portabilità & Il sistema dovrà funzionare sul browser Safari dalla versione più recente (5.1.7) & Capitolato \\ \hline
