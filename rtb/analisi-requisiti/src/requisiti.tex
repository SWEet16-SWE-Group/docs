...
\begin{itemize}
    \item Requisiti funzionali,i quali sono strettamente legati alle funzionalità che il prodotto deve offrire agli utenti,
    al modo in cui il prodotto deve reagire a determinati input e al modo in cui deve comportarsi in determinate situazioni;
    \item Requisiti non funzionali,i quali rappresentano dei vincoli che il prodotto deve rispettare,legati ai molteplici 
    aspetti che caratterizzano il comportamento di un prodotto software ,come ad es. la scalabilità,la sicurezza, la performance .
\end{itemize}
