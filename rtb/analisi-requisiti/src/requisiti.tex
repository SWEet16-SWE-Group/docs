...
relativo requisito è obbligatorio (RNFO), desiderabile (RNFD) o facoltativo (RNFF); vengono inoltre indicati
...
\begin{center}
    \begin{tblr}{
        ...
        RNFO1 & Sviluppo & Il prodotto deve essere sviluppato in modo concorde a quanto stabilito nelle Norme di Progetto & Brainstorming Interno \\ \hline
        RNFO2 & Sviluppo & Il progetto deve essere accessibile pubblicamente su GitHub$^{G}$ & Brainstorming Interno \\ \hline
        RNFO3 & Sviluppo & Devono essere realizzati i test di unità ed integrazione con una copertura minima del 80\% & Capitolato \\ \hline
        RNFO4 & Sviluppo & Deve essere fornita una completa documentazione sulle scelte implementative e progettuali e relative motivazioni & Capitolato \\ \hline
        RNFO5 & Sviluppo & Deve essere fornita una completa documentazione sui problemi aperti e sulle eventuali soluzioni da esplorare & Capitolato \\ \hline
        \end{tblr}
\end{center}
...
\begin{center}
    \begin{tblr}{
        ...
        RNFVO1 & Sviluppo & Il sistema sarà sviluppato e consegnato tramite piattaforma Docker & Capitolato \\ \hline

        % le versioni sono quelle uscite nel 2021
        RNFVO2 & Portabilità & Il sistema dovrà funzionare sul browser Firefox dalla versione 95 & Capitolato \\ \hline
        RNFVO3 & Portabilità & Il sistema dovrà funzionare sul browser Chromium dalla versione 90 & Capitolato \\ \hline
        RNFVO4 & Portabilità & Il sistema dovrà funzionare sul browser Safari dalla versione 15 & Capitolato \\ \hline
