...
\begin{center}
    ...
    \end{longtblr}
    \end{center}
\subsection{Requisiti non funzionali} % rivederli completamente
...
\begin{center}
    \begin{tblr}{
        ...
        % secondo cardin questo (rnfo1) non è un requisito. se lo dice lui.
        % Dobbiamo riferirci a standard. Inoltre è obbligatorio fornire le versioni minime supportate di ogni browser.
         ...
         % Questo requisito non è verificabile
         ...
         % qui invece descrivere quale sistema di crittografia utilizzare (ma nell'AdR non dovevamo tralasciare gli aspetti implementativi? XD)
         % e tra l'altro è requisito funzionale
        ...
        % questo non è un requisito (cancellarlo)

        % ora la domanda sporge spontanea, ma cosa sono allora i requisiti non funzionali? 
        \end{tblr}
\end{center}

% mancano inoltre completamente i requisiti di qualità, "ossia quelli che vincolano il processo di sviluppo"
