...
\begin{center}
    \begin{tblr}{
        ...
        % TODO sviluppo secondo le norme di progetto
        % TODO github
        % TODO manuale utente
        % TODO test di unità e integrazione (?)
...
\begin{center}
    \begin{tblr}{
        ...
        RNFV2 & Sviluppo & Il sitema dovrà funzionare sul browser Firefox dalla versione più recente (124.0) & Capitolato \\ \hline
        RNFV3 & Sviluppo & Il sitema dovrà funzionare sul browser Chromium dalla versione più recente (123.0.6312.58) & Capitolato \\ \hline
        RNFV5 & Sviluppo & Il sitema dovrà funzionare sul browser Safari dalla versione più recente (5.1.7) & Capitolato \\ \hline
