...
\begin{center}
    \begin{tblr}{
        ...
        \textbf{Codice} & \textbf{Caratteristica} & \textbf{Descrizione} & \textbf{Fonte} \\
         ...
         RFD3 & Sicurezza & Le comunicazioni tra il client e il server devono essere crittografate, data la natura sensibile dei dati inseriti dagli utenti (SSL/TLS) & Capitolato \\ \hline
