...
\begin{figure}[h] \includegraphics[scale=1]{GanttPrimoPeriodo.png} \end{figure}
...
\begin{figure}[h] \includegraphics[scale=1]{GanttSecondoPeriodo.png} \end{figure}
...
\begin{figure}[h] \includegraphics[scale=1]{GanttTerzoPeriodo.png} \end{figure}
