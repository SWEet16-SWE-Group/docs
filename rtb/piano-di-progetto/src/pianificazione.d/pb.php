...
$periodi_rtb = [
  ...
  [
    4 => [
      'Alberto C.'  =>  [0, 0,  5, 0, 0, 0,  5],
      'Bilal El M.' =>  [0, 0,  5, 0, 0, 7, 12],
      'Alberto M.'  =>  [0, 0, 10, 0, 0, 2, 12],
      'Alex S.'     =>  [0, 5,  5, 0, 0, 0, 10],
      'Iulius S.'   =>  [0, 0, 10, 0, 0, 2, 12],
      'Giovanni Z.' =>  [5, 0,  0, 0, 0, 0,  5],
    ],
    5 => [
      'Alberto C.'  => [0, 2,  3, 0, 0, 0,  5],
      'Bilal El M.' => [0, 0,  2, 0, 0, 3,  5],
      'Alberto M.'  => [0, 0, 12, 0, 0, 5, 17],
      'Alex S.'     => [0, 5, 10, 0, 0, 5, 20],
      'Iulius S.'   => [0, 0, 12, 0, 0, 5, 17],
      'Giovanni Z.' => [5, 0,  3, 0, 0, 2, 10],
    ],
  ],
  // ===========================================================================================================================
  // RTB 4
  [
    4 => [
      'Alberto C.'  =>  [0, 0, 0, 2, 0, 3,  5],
      'Bilal El M.' =>  [2, 2, 4, 2, 0, 5, 15],
      'Alberto M.'  =>  [0, 0, 4, 0, 0, 5,  9],
      'Alex S.'     =>  [2, 3, 0, 0, 0, 0,  5],
      'Iulius S.'   =>  [0, 0, 4, 0, 0, 5,  9],
      'Giovanni Z.' =>  [0, 0, 0, 5, 0, 5, 10],
    ],
    5 => [
      'Alberto C.'  => [0, 0, 0, 2, 0, 3,  5],
      'Bilal El M.' => [2, 0, 4, 2, 0, 5, 13],
      'Alberto M.'  => [0, 0, 4, 0, 0, 5,  9],
      'Alex S.'     => [5, 5, 0, 0, 0, 0, 10],
      'Iulius S.'   => [0, 0, 4, 0, 0, 5,  9],
      'Giovanni Z.' => [0, 0, 0, 5, 0, 5, 10],
    ],
  ],
