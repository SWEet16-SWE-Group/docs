...
select assert(insert_ristoratori(1) = 0, 'insert_ristoratori: già esistente in ristoratori');
select assert(insert_ristoratori(2) = 0, 'insert_ristoratori: già esistente in clienti');
